...
/*	--------------------------------------------------
  ...
  $youremail = 'aonmedia@live.com';
	...
	$company = 'National Office Products';
...
/*	--------------------------------------------------
	...
	$baseurl = '//'.$_SERVER['SERVER_NAME'].'/form/';
...
/*	--------------------------------------------------
	...
	// IF YOU USE UNICODE CHARACTER IN YOUR LANGUAGE LIKE ARABIC, JAPANESE, RUSSIAN, CHINESE IN YOUR $notification TURN TRUE!
	$unicode = false;
...
/*	--------------------------------------------------
	...
	$emailsupportone   = 'aonmedia@live.com'; // EMAIL RELATED TO DEPARTMENT1!
	...
	$emailsupportfour  = 'aonmedia@live.com'; // ENAIL RELATED TO DEPARTMENT4!
...
/*	--------------------------------------------------
  ...
  $amazonattachments = false;
	...
	$dropboxtoken = '3m3yeyeuy07xm0e';
	$dropboxfolder = '/website-uploads';
