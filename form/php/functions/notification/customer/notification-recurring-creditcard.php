			...
			if($automessage == true){
				...
				if ($mysql == true){
					...
					if($signature == true){
						...
						$creditcardcustomer = Braintree_Customer::create(array(
							'id' => $finalcustomerid,
							'firstName' => $finalfirstname,
							'lastName' => $finallastname,
							'email' => $finalemail,
							'creditCard' => array(
								'cardholderName' => $finalcreditcardname,
								'number' => $finalcreditcardnumber,
								'expirationDate' => $finalcreditcarddate,
								'cvv' => $finalcreditcardcvv
							)
						));
						
						if($creditcardcustomer->success){
												
							$finalcreditcardtoken = $creditcardcustomer->customer->paymentMethods[0]->token;
							
							$creditcardsubscription = Braintree_Subscription::create(array(
								'paymentMethodToken' => $finalcreditcardtoken,
								'planId' => $finalrecurringplan
							));
											
							if($creditcardsubscription->success){
