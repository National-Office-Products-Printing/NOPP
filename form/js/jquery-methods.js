...
}, $.validator.format("Please submit at least 2 file."));

$.validator.addMethod("maxupload", function(value, element, param) {
    var length = ( element.files.length );
    return this.optional( element ) || length <= param;
}, $.validator.format("Please submit 3 maximum number of files."));
...
$.validator.addMethod("cardexpire", function() {
	return Stripe.validateExpiry($("#stripe-month").val(), $("#stripe-year").val())
