...
(function() {
  var $, cardFromNumber, cardFromType, cards, defaultFormat, formatBackCardNumber, formatBackExpiry, formatCardNumber, formatExpiry, formatForwardExpiry, formatForwardSlashAndSpace, formatMonthExpiry, formatYearExpiry, handleIMEKeydown, handleIMEKeyup, hasTextSelected, luhnCheck, reFormatCVC, reFormatCardNumber, reFormatExpiry, reFormatNumeric, restrictCVC, restrictCardNumber, restrictExpiry, restrictFourDigitYearExpiry, restrictMonthExpiry, restrictNumeric, safeVal, setCardType,
    __slice = [].slice,
  ...
  restrictFourDigitYearExpiry = function(e) {
    var $target, digit, value;
    $target = $(e.currentTarget);
    digit = String.fromCharCode(e.which);
    if (!/^\d+$/.test(digit)) {
