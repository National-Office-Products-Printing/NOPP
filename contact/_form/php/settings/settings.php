...
/*	--------------------------------------------------
	...
	$baseurl = '//'.$_SERVER['SERVER_NAME'].'/folder/';
...
/*	--------------------------------------------------
	...
	$adminemailone   = 'example@example.com';
	$adminemailtwo   = 'example@example.com';
	$adminemailthree = 'example@example.com';
	
	$administratorscc = false;
	
	$adminccemailone   = 'example@example.com';
	$adminccemailtwo   = 'example@example.com';
	$adminccemailthree = 'example@example.com';
	
	$administratorsbcc = false;
	
	$adminbccemailone   = 'example@example.com';
	$adminbccemailtwo   = 'example@example.com';
	$adminbccemailthree = 'example@example.com';
...
/*	--------------------------------------------------
	...
	$emailsupportone   = 'example@example.com'; // EMAIL RELATED TO DEPARTMENT1!
	$emailsupporttwo   = 'example@example.com'; // EMAIL RELATED TO DEPARTMENT2!
	$emailsupportthree = 'example@example.com'; // EMAIL RELATED TO DEPARTMENT3!
	$emailsupportfour  = 'example@example.com'; // ENAIL RELATED TO DEPARTMENT4!
...
/*	-------------------------------------------------------------
	...
	$subjectfield                = true;  // TURN TRUE OR FALSE!
	$messagefield                = true;  // TURN TRUE OR FALSE!
	$supportfield                = true;  // TURN TRUE OR FALSE!
	$upload1field                = true;  // TURN TRUE OR FALSE!
	$upload2field                = true;  // TURN TRUE OR FALSE!
	$upload3field                = true;  // TURN TRUE OR FALSE!
	$uploadmultiplefield         = true;  // TURN TRUE OR FALSE!
	$servicefield                = true;  // TURN TRUE OR FALSE!
	$paymentfield                = true;  // TURN TRUE OR FALSE!
	$recurringfield              = true;  // TURN TRUE OR FALSE!
	$cardnamefield               = true;  // TURN TRUE OR FALSE!
	$cardnameerrorfield          = true;  // TURN TRUE OR FALSE!
	$cardnumberfield             = true;  // TURN TRUE OR FALSE!
	$cardnumbererrorfield        = true;  // TURN TRUE OR FALSE!
	$carddatefield               = true;  // TURN TRUE OR FALSE!
	$carddateerrorfield          = true;  // TURN TRUE OR FALSE!
	$cardmonthfield              = true;  // TURN TRUE OR FALSE!
	$cardmontherrorfield         = true;  // TURN TRUE OR FALSE!
	$cardyearfield               = true;  // TURN TRUE OR FALSE!
	$cardyearerrorfield          = true;  // TURN TRUE OR FALSE!
	$cardcvvfield                = true;  // TURN TRUE OR FALSE!
	$cardcvverrorfield           = true;  // TURN TRUE OR FALSE!
	$newsletterfield             = true;  // TURN TRUE OR FALSE!
	$sendtomefield               = true;  // TURN TRUE OR FALSE!
	$captchafield                = true;  // TURN TRUE OR FALSE!
...
/*	--------------------------------------------------
	...
	$recaptchatheme = 'your-recaptcha-theme'; // light or dark!
