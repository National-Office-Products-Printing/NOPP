...
<html>
    ...
    <script type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/2.1.4/jquery.min.js"></script>
		...
		<!-- Js Files -->
		<script type="text/javascript" src="js/jquery-customize.js"></script>
		<script type="text/javascript" src="js/jquery-validate.js"></script>
		<script type="text/javascript" src="js/jquery-methods.js"></script>
        ...
        <div class="frame">
          <div class="column-main">
              ...
              <!-- CUSTOMER FIRST NAME -->
                ...
                <strong><?php echo $lang['form-label-first-name'];?></strong>
              ...
              <!-- CUSTOMER LAST NAME (please edit the label function here) -->
  						<label for="lastname">
                <i class="fa fa-user color-3">&nbsp;</i>
                <strong><?php echo $lang['form-label-last-name'];?></strong>
              ...
              <!-- DEPARTMENT LISTING -->
  						<?php if($merchantsupport == true && $supportselect == true){ ?>
  							<label for="support">
                  <i class="fa fa-question color-3">&nbsp;</i>
                  <strong><?php echo $lang['form-label-select'];?></strong>
  								<select id="support" name="support[]" data-rule-required="<?php echo $supportfield;?>" data-msg-required="<?php echo $lang['form-required-support'];?>" class="select">
              ...
              <!-- CAPTCHA -->
  						<?php if($captcha == true){ ?>
  							<label for="g-recaptcha-response" class="gcaptcha">
  								<input type="text" id="g-recaptcha-response" name="g-recaptcha-response" data-rule-required="<?php echo $captchafield;?>" data-rule-remote="<?php echo $baseurl;?>php/functions/captcha/recaptcha/processor-captcha.php" data-msg-required="<?php echo $lang['form-required-recaptcha'];?>" data-msg-remote="<?php echo $lang['form-error-recaptcha'];?>" autocomplete="off" class="captcha-hidden" placeholder="<?php echo $lang['form-placeholder-recaptcha'];?>">
              ...
              <!-- FORM ACTION BUTTONS -->
  						<button type="submit" id="contact-button" class="button-1 small"><?php echo $lang['form-button-submit'];?></button>
  						<button type="reset" id="reset-button" class="button-1 small"><?php echo $lang['form-button-reset'];?></button>
